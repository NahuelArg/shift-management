                            ...
                            {bookings.map((booking) => (
                                ...
                                >
                                    <div className="flex justify-between items-center">
                                        <div>
                                            <p>Fecha: {new Date(booking.date).toLocaleDateString('es-ES')}</p>
                                            <p>Hora: {new Date(booking.date).toLocaleTimeString('es-ES', { hour: '2-digit', minute: '2-digit' })} - {new Date(booking.endTime).toLocaleTimeString('es-ES', { hour: '2-digit', minute: '2-digit' })}</p>
